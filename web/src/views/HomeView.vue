  ...
  >
    <div class="w-full lg:w-2/5">
      <div class="mx-auto mb-8 max-w-lg lg:mx-0 lg:max-w-md lg:text-left">
        <h2 class="mb-4 text-3xl font-bold lg:text-left text-center lg:text-5xl">
          Онлайн-сервис
        ...
        >
          Сервис доставки документов в любую точку Казахстана. Доставка документов осуществляется в
          течение 1-2 дней.
        </p>
      </div>
