...
<template>
  <section
    class="flex flex-wrap items-center mt-10 font-sans px-4 justify-between mx-auto w-full lg:max-w-screen-lg sm:max-w-screen-sm md:max-w-screen-md pb-20"
  >
    <div class="w-full lg:w-2/5">
      <div class="mx-auto mb-8 max-w-lg lg:mx-0 lg:max-w-md lg:text-left">
        <h2
          class="mb-4 text-3xl font-bold lg:text-left text-center lg:text-5xl"
        >
          Онлайн-сервис
          <span class="text-green-500">доставки </span>
          документов
        </h2>

        <p
          class="visible mx-0 mt-3 text-center lg:text-left mb-0 text-sm leading-relaxed text-left text-slate-400"
        >
          Сервис доставки документов в любую точку Казахстана. Доставка
          документов осуществляется в течение 1-2 дней.
        </p>
      </div>

      <div class="text-center lg:text-left">
        <n-input-group>
          <n-input v-model:value="document" placeholder="Номер документа" />
          <n-button
            type="primary"
            ghost
            :style="{ width: '33%' }"
            tag="a"
            :href="`/order-document/${document}`"
          >
            Заказать
          </n-button>
        </n-input-group>
    ...
    <div class="px-3 mb-12 w-full lg:mb-0 mt-12 lg:w-3/5">
      <div class="flex justify-center items-center">
        ...
        >
          ...
          />
          <path
            id="b582f34e-fd02-4670-b1d8-d23f069ed737-297"
            data-name="Path 395"
